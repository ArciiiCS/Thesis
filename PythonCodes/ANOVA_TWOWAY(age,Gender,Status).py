...
df = pd.DataFrame({'Variable_A':['MALE', 'FEMALE','FEMALE','FEMALE','MALE','MALE','FEMALE','FEMALE','FEMALE','MALE'],
               'Variable_B': ['distressed','stressed','distressed','stressed','distressed','stressed','distressed','stressed','distressed','stressed'],
               'Variable_E': [21,42,1,1,1,21,39,1,2,6]})
